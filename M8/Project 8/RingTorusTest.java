...
public class RingTorusTest {
   ...
   */
    ...
    * the new large radius of the RingTorus object is equal to 4.0.
    */
   @Test public void setLargeRadiusTest4() {
      RingTorus ring1 = new RingTorus("Test1234", 4.0, 2.0);
      Assert.assertTrue(ring1.setLargeRadius(3.0));
      Assert.assertFalse(ring1.setLargeRadius(1.0));
    ...
    * class by initializing a new RingTorus object with a large radius 
    * of 2.0 and a small radius of 1.0.The setLargeRadius method is then 
    * called with an input of 0.5, and the assertEquals method checks that 
    * the new large radius of the RingTorus object is equal to 2.0.
    */
   @Test public void setLargeRadiusTest2() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.0);
      ring1.setLargeRadius(0.5);
      Assert.assertEquals(ring1.getLargeRadius(), 2.0, 0.00001);
    ...
    * class by initializing a new RingTorus object with a large radius 
    * of 2.0 and a small radius of 1.0.The setLargeRadius method is then 
    * called with an input of -1.0, and the assertEquals method checks that 
    * the new large radius of the RingTorus object is equal to 2.0.
    */
   @Test public void setLargeRadiusTest3() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.5);
      ring1.setLargeRadius(-1.0);
      Assert.assertEquals(ring1.getLargeRadius(), 2.0, 0.00001);
    ...
    * the new large radius of the RingTorus object is equal to 2.0.
    */
   @Test public void setLargeRadiusTest5() {
      RingTorus ring1 = new RingTorus("Test", 0, -1.5);
      ring1.setLargeRadius(-2.0);
      Assert.assertEquals(ring1.getLargeRadius(), 0, 0.00001);
    ...
    * of 2.0 and a small radius of 1.0. The setSmallRadius method is then 
    * called with an input of 4.0, and the assertEquals method checks that 
    * the new small radius of the RingTorus object is equal to 1.0.
    */
   @Test public void setSmallRadiusTest2() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.0);
      ring1.setSmallRadius(4);
      Assert.assertEquals(ring1.getSmallRadius(), 1.0, 0.00001);
   }
    ...
    * the new small radius of the RingTorus object is equal to 1.0.
    */
   @Test public void setSmallRadiusTest3() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.0);
      ring1.setSmallRadius(-1);
      Assert.assertEquals(ring1.getSmallRadius(), 1.0, 0.00001);
   }
   ...
   */
   ...
   /**
    * This test method tests the equals method in the RingTorus class.
    * 1 instance of RingTorus is created and one is null. These instances
    * are  not equal. This method tests if the equals method returns that these
    * 2 instances are not equal.
    */
   @Test public void equalsTest2() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.0);
      RingTorus ring2 = null;
      Assert.assertFalse(ring1.equals(ring2));
   }
   
   /**
    * This test method tests the equals method in the RingTorus class.
    * 2 instances of RingTorus are created. These instances are not equal.
    * This method tests if the equals method returns that these 2 instances
    * are not equal.
    */
   @Test public void equalsTest3() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.0);
      RingTorus ring2 = new RingTorus("Test", 3.0, 1.0);
      Assert.assertFalse(ring1.equals(ring2));
   }
   ...
   @Test public void equalsTest4() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.0);
      RingTorus ring2 = new RingTorus("Test", 2.0, 1.5);
      Assert.assertFalse(ring1.equals(ring2));
   }
   ...
   @Test public void equalsTest5() {
      RingTorus ring1 = new RingTorus("Test", 2.0, 1.0);
      RingTorus ring2 = new RingTorus("Test2", 2.0, 1.5);
      Assert.assertFalse(ring1.equals(ring2));
   }
   ...
   /**
    * Tests the RingTorus compareTo method with equal values.
    */
   @Test public void compareToTest1() {
      RingTorus rt1 = new RingTorus("Test", 3.0, 1.0);
      RingTorus rt2 = new RingTorus("Test", 3.0, 1.0);
   
      Assert.assertTrue(rt1.compareTo(rt2) == 0);
   }

   /**
    * Tests the RingTorus compareTo method with a larger value.
    */
   @Test public void compareToTest2() {
      RingTorus rt1 = new RingTorus("Test", 3.0, 1.0);
      RingTorus rt2 = new RingTorus("Test", 2.0, 1.0);
   
      Assert.assertTrue(rt1.compareTo(rt2) > 0);
   }

   /**
    * Tests the RingTorus compareTo method with a smaller value.
    */
   @Test public void compareToTest3() {
      RingTorus rt1 = new RingTorus("Test", 2.0, 1.0);
      RingTorus rt2 = new RingTorus("Test", 3.0, 1.0);

         ...
         try {
            switch (type) {
               ...
               case 'P':
                  ...
                  int itemQuantP = Integer.parseInt(lineScan.next());
                  double itemCrustP = Double.parseDouble(lineScan.next());
               ...
               case 'K':
                  ...
                  int itemQuantK = Integer.parseInt(lineScan.next());
                  int itemLayersK = Integer.parseInt(lineScan.next());
